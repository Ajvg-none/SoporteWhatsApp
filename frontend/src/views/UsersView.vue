  ...
  <div class="animate-fadeIn space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-gray-500 dark:text-gray-300 mt-1">Administra los técnicos y supervisores del sistema</p>
      </div>
      <BaseButton
        variant="primary"
    ...
    <div v-if="loading" class="flex flex-col items-center justify-center py-20">
      ...
      <span class="text-sm font-semibold text-gray-400 dark:text-gray-300">Cargando usuarios...</span>
    </div>
    ...
    <div v-else-if="users.length === 0" class="text-center py-16">
      ...
      <p class="text-gray-700 dark:text-gray-300 font-bold text-sm">No hay usuarios registrados</p>
      <p class="text-gray-400 text-xs font-semibold mt-1">Crea el primer técnico para comenzar</p>
    </div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-100/40 dark:divide-gray-500">
          <thead class="bg-gray-50/50 dark:bg-[#757575]">
            <tr>
              <th class="px-6 py-4 text-left text-[10px] font-extrabold text-gray-400 dark:text-gray-200 uppercase tracking-wider">Nombre</th>
              <th class="px-6 py-4 text-left text-[10px] font-extrabold text-gray-400 dark:text-gray-200 uppercase tracking-wider">Email</th>
              <th class="px-6 py-4 text-left text-[10px] font-extrabold text-gray-400 dark:text-gray-200 uppercase tracking-wider">Rol</th>
          ...
          <tbody class="bg-white dark:bg-card-dark divide-y divide-gray-100/40 dark:divide-gray-500">
            ...
            <tr
              v-for="user in users"
              :key="user.id"
              class="hover:bg-primary-light/10 dark:odd:bg-[#A9A9A9] dark:hover:bg-[#B4B4B4] transition-colors duration-150"
    ...
    >
      <form @submit.prevent="handleCreateUser" class="space-y-4">
        ...
        />
        <div>
          <label class="block text-xs font-bold uppercase tracking-wider text-gray-400 dark:text-gray-300 mb-1.5">Rol</label>
          <select
            v-model="form.rol"
